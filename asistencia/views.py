...
class AsistenciaCreateView(LoginRequiredMixin ,View):
    def get(self,request, *args, **kwargs):
...
class AsistenciaDetailsView(LoginRequiredMixin, View):
...
class AsistenciaEditView(LoginRequiredMixin, UpdateView):
    model = Asistencia
